#!/usr/bin/env python3
"""Lists the valid Hermes petdex pets under one directory.

Reads pet.json + spritesheet from each subdirectory of <petsDir>, validates
the atlas (1536 wide, 9-32 rows of 208, PNG/WebP), and prints one line per
valid pet to stdout. Used by PetLibrary.qml at panel open time.
"""
import errno
import itertools
import json
